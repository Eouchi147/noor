...
const UI_EN = {
  ...
  "hero2.sub":"The whole of Islam, one illuminated library: the story in order, the Qur'an with recitation, an encyclopedia of the Path, a full madrasa, and rooms for every age. Free forever.","hero2.lead":"The whole of Islam, one illuminated library: the story in order, the Qur'an recited, every word explained. Free forever.","hero2.more":"A full madrasa, rooms for every age, and a lantern that lights something new each day.","hero2.search":"Search anything: a word, a prophet, a place, a surah\u2026","hero2.door.mushaf":"The Mushaf","hero2.door.mushaf.s":"Every ayah, with recitation","hero.cta.characters":"Characters","hero.cta.kids":"✦ Little Codex",
