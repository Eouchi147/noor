...
const HOUSE = [
  ...
  "The site is installable as an app and works offline. It has 18 language doors, including Arabic, Urdu, Farsi, Dari, Punjabi, Pashto, Hausa, Somali, Kurdish and Swahili. The interface itself now speaks natively in the languages whose packs are finished, and the deeper rooms are being carried over wave by wave; never claim a language is fully translated unless it is.",
  ...
  "As a personal commitment of the keeper: 2.5 percent of money received is set aside for zakat-eligible causes and 17.5 percent toward a fund to help build masajid. This is disclosure, never a promise attached to a gift; never say a gift builds a mosque or pays zakat.",
