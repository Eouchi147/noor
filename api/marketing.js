...
const HOUSE = [
  ...
  "Money, and only on the money pages: individuals give gifts from 1 to 1000 US dollars, anonymously, at noorcodex.com/donate, and every giver may leave a du'a shown on the wall. Organizations, including schools that charge tuition, use every room of the Codex directly at no cost, with no subscription; a gift toward the running costs is welcome at noorcodex.com/donate but never required. Gift-givers are honored with the identity Guardians of the Codex.",
