...
Design principle: **publishing = the owner's git push.** No dashboard writes to the site; the Console generates a file only Sam can commit. That is the enforcement of "only I get the final word."
