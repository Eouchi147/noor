...
var V = "noor-v123";  // bump this on EVERY release that changes an asset. Assets are served cache-first below, so a reader who does not get a new cache name keeps the old file for a whole visit.
var CORE = [
