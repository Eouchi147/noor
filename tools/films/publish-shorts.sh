...
echo "  Open out/main in Finder, select everything in it, and drag it onto"
echo "  github.com/Eouchi147/noor/upload/main; or hand it to the Director."
echo "  The house never pushes: this is the folder to carry, the same way"
echo "  every other reels update reaches main."
